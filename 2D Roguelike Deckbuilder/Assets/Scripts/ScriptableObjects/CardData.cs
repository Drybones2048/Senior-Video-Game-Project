...
public enum UniqueBehavior { None, PressAndFall, PiercingStrike, EmpoweringShield, Juggernaut, RiteOfFrailty } //going to add more here once I decide what needs unique behavior
